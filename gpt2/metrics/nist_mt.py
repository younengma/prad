...
def compute_nist(predictions, references, n: int = 5, lowercase=False, western_lang=True):
    tokenizer = NISTTokenizer()
    ...
    try:
        score = corpus_nist(list_of_references=references, hypotheses=predictions, n=n)
        return score
